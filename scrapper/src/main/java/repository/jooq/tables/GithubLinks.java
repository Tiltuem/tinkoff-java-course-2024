...
public class GithubLinks extends TableImpl<GithubLinksRecord> {
     ...
     */
    public final TableField<GithubLinksRecord, LocalDateTime> LAST_PUSH = createField(DSL.name("LAST_PUSH"), SQLDataType.LOCALDATETIME(6), this, "");
     ...
     */
    public <U> SelectField<U> mapping(Function3<? super Long, ? super LocalDateTime, ? super Integer, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function3<? super Long, ? super LocalDateTime, ? super Integer, ? extends U> from) {
